...
from Helmet_Detection_PyTorch.entity.config_entity import ModelPusherConfig
from Helmet_Detection_PyTorch.entity.artifacts_entity import ModelPusherArtifacts
