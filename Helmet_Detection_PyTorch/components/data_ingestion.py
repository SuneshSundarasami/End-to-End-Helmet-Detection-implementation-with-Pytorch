...
from Helmet_Detection_PyTorch.entity.config_entity import DataIngestionConfig
from Helmet_Detection_PyTorch.entity.artifacts_entity import DataIngestionArtifacts
