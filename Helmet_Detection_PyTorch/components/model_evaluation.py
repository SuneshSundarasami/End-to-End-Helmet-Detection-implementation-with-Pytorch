...
from Helmet_Detection_PyTorch.constants import *
from Helmet_Detection_PyTorch.logger import logging
from Helmet_Detection_PyTorch.exception import HelmetException
from Helmet_Detection_PyTorch.utils.main_utils import load_object
from Helmet_Detection_PyTorch.entity.config_entity import ModelEvaluationConfig
from Helmet_Detection_PyTorch.configuration.s3_operations import S3Operation
from Helmet_Detection_PyTorch.entity.artifacts_entity import ModelTrainerArtifacts, DataTransformationArtifacts, ModelEvaluationArtifacts
...
class ModelEvaluation:
    ...
    def initiate_model_evaluation(self) -> ModelEvaluationArtifacts:
        ...
        try:
            trained_model = torch.load(self.model_trainer_artifacts.trained_model_path,weights_only=False)
            ...
            s3_model = torch.load(s3_model, map_location=torch.device(DEVICE),weights_only=False)
